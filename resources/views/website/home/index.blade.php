...
@section('body')
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-xl-10">
                    <div class="heading-title text-center">
                        <img src="{{asset('/')}}website/assets/images/logo-icon.png" height="50" alt="">
    ...
    <section class="section pb-0">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="position-relative">
                        <img src="{{asset('/')}}website/assets/images/about/about-2.png" class="img-fluid" alt="">
                        <div class="play-icon">
        ...
        <div class="container-fluid mt-100 mt-60">
            <div class="py-5 rounded" style="background: url('{{asset('/')}}website/assets/images/bg/05.jpg') center left;">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="client-review-slider">
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/01.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                    ...
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/02.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                    ...
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/03.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                    ...
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/04.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                    ...
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/05.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                    ...
                                    <div class="tiny-slide">
                                        ...
                                        <div class="d-inline-flex align-items-center">
                                            <img src="{{asset('/')}}website/assets/images/client/06.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="row mt-4">
                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/amazon.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->

                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/google.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->

                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/lenovo.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->

                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/paypal.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->

                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/shopify.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->

                        <div class="col-lg-3 col-md-4 col-6 text-center py-4">
                            <img src="{{asset('/')}}website/assets/images/client/spotify.png" class="avatar avatar-client" alt="">
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end col-->
            </div><!--end row-->
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        <div class="team-img position-relative">
                            <img src="{{asset('/')}}website/assets/images/doctors/01.jpg" class="img-fluid" alt="">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        <div class="team-img position-relative">
                            <img src="{{asset('/')}}website/assets/images/doctors/02.jpg" class="img-fluid" alt="">
                            <ul class="list-unstyled team-social mb-0">
                                <li><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="facebook" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="linkedin" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="github" class="icons"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        <div class="team-img position-relative">
                            <img src="{{asset('/')}}website/assets/images/doctors/03.jpg" class="img-fluid" alt="">
                            <ul class="list-unstyled team-social mb-0">
                                <li><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="facebook" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="linkedin" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="github" class="icons"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mt-4 pt-2">
                    <div class="card team border-0 rounded shadow overflow-hidden">
                        <div class="team-img position-relative">
                            <img src="{{asset('/')}}website/assets/images/doctors/04.jpg" class="img-fluid" alt="">
                            <ul class="list-unstyled team-social mb-0">
                                <li><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="facebook" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="linkedin" class="icons"></i></a></li>
                                <li class="mt-2"><a href="javascript:void(0)" class="btn btn-icon btn-pills btn-soft-primary"><i data-feather="github" class="icons"></i></a></li>
