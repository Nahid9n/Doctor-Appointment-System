        ...
        <div class="col-lg-8 mt-4">
            <div class="card border-0 p-4 rounded shadow">
                <div class="row justify-content-center align-items-center">
                    ...
                    <form class="mt-4" action="{{route('doctor-department.update',$department->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-5 col-md-4">
                                <img src="{{asset($department->banner)}}" id="show_image" class="avatar avatar-md-md rounded-pill shadow mx-auto d-block" alt="banner">
                            </div>
                            <!--end col-->
                        ...
                        <div class="row my-5">
                            <div class="mb-3">
                                ...
                                <input name="name" id="name" value="{{$department->name}}" type="text" class="form-control" placeholder="First Name :">
                            </div>
                            <!--end col-->
                            <div class="mb-3">
